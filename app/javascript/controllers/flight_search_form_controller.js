...
export default class extends Controller {
  ...
  updateAirports(event) {
    ...
    console.log(`Updating ${targetElement.name} airports select with ${selectedCountry} only airports`);
  ...
  updateDepartureDates(event) {   
    console.log(`################## updateDepartureDates function called #############`);
    ...
    if (selectedDepartureAirport && selectedArrivalAirport) {
      ...
      console.log(`both airports now chosen, therefore calling Flights#update_departure_dates with args;
